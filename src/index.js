...
const installedIconPath = join(runtimeDir, 'assets', 'dsh-web-launcher-whale-rounded.ico')
const sourceIconPath = resolve(packageRoot, 'assets', 'dsh-web-launcher-whale-rounded.ico')
